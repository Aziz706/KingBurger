          ...
          <div className={s.row}>
            ...
            <div className={s.image}>
              ...
              <div className="card-body">
                <h3 className="text-left my-2">{props.pizza.name}</h3>
                <hr /><br />
                <hr /><br />
                <div className={s.container2}>
                  <p className="">{props.pizza.price}</p>
                </div><br /><br />
            ...
            onClick={() => props.handleSave(props.pizza)}
  ...
  return (
    <div className="container w-100">
      ...
      {props.loading === true ? (
        ...
        <div className="w-100">
        <ShowProduct />
        <CustomizedAccordions desc = {props.pizza} />
        <RelatedProducts />
        </div>
      )}
    </div>
...
export default connect((state) => state.pizzaReducer, actions)(Section4id);
