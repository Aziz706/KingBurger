...
import { MdChevronLeft,MdChevronRight } from 'react-icons/md';import { actions } from "../../redux/IceCream";
;


function Section6id(props) {
  const { id } = useParams();

  const fetchDetails = useCallback(() => {
    props.Loading(true);
    props.getIceCream(id);
          ...
          <div className={s.row}>
            ...
            <div className={s.image}>
              ...
              <div className="card-body">
                <h3 className="text-left my-2">{props.iceCream.name}</h3>
                <hr /><br />
                <hr /><br />
                <div className={s.container2}>
                  <p className="">{props.iceCream.price}</p>
                </div><br /><br />
            ...
            onClick={() => props.handleSave(props.iceCream)}
...
export default connect((state) => state.iceCreamReducer, actions)(Section6id);
