...
import s from "./Section3id.module.scss";
          ...
          <div className={s.row}>
            <div className="d-flex flex-wrap justify-content-between">
              ...
              <div className="card-body">
                <h3 className="text-left my-2">{props.post.name}</h3>
                <hr /><br />
                <hr /><br />
                <div className={s.container2}>
                  <p className="">{props.post.price}</p>
                </div><br /><br />
            ...
            onClick={() => props.handleSave(props.post)}
...
export default connect((state) => state.postReducer, actions)(Section3id);
