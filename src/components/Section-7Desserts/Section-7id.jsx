          ...
          <div className={s.row}>
            ...
            <div className={s.image}>
              ...
              <div className="card-body">
                <h3 className="text-left my-2">{props.dessert.name}</h3>
                <hr /><br />
                <hr /><br />
                <div className={s.container2}>
                  <p className="">{props.dessert.price}</p>
                </div><br /><br />
            ...
            onClick={() => props.handleSave(props.dessert)}
...
export default connect((state) => state.dessertReducer, actions)(Section7id);
