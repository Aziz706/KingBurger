...
function Section5id(props) {
  const { id } = useParams();

  const fetchDetails = useCallback(() => {
    props.Loading(true);
    props.getFriedChick(id);
          ...
          <div className={s.row}>
            ...
            <div className={s.image}>
              ...
              <div className="card-body">
                <h3 className="text-left my-2">{props.friedChick.name}</h3>
                <hr /><br />
                <hr /><br />
                <div className={s.container2}>
                  <p className="">{props.friedChick.price}</p>
                </div><br /><br />
            ...
            onClick={() => props.handleSave(props.friedChick)}
...
export default connect((state) => state.friedChickReducer, actions)(Section5id);
